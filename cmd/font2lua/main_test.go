...
v22q0 38 -30.5 58t-86.5 20q-58 0 -88 -22.5t-35 -70.5h-84zM220 50q69 0 113 36.5t44 78.5v94q-25 -12 -75.5 -20t-87.5 -14t-67 -28.5t-30 -62.5t27 -62t76 -22z`),
	...
	wantFaces := []*faceT{
		{
			dParts: []string{
				"M53 369", "q6 170 210 170", "q97 0 147 -36.5", "t50 -106.5", "v-308", "q0 -41 45 -41", "q9 0 18 2", "v-63", "q-35 -9 -57 -9", "q-40 0 -60.5 18.5", "t-25.5 58.5", "q-84 -77 -178 -77", "q-79 0 -125.5 42", "t-46.5 113", "q0 23 4.5 42", "t10 33.5", "t19.5 27", "t23.5 20.5", "t32 15.5", "t34.5 11", "t42 8.5", "t44 7", "t50 7", "q49 6 68 19", "t19 39\n", "v22", "q0 38 -30.5 58", "t-86.5 20", "q-58 0 -88 -22.5", "t-35 -70.5", "h-84z",
			},
			verts: []vec2{
				{53, 369}, {263, 539}, {410, 502.5}, {460, 396}, {460, 88}, {505, 47}, {523, 49}, {523, -14}, {466, -23}, {405.5, -4.5}, {380, 54}, {202, -23}, {76.5, 19}, {30, 132}, {34.5, 174}, {44.5, 207.5}, {64, 234.5}, {87.5, 255}, {119.5, 270.5}, {154, 281.5}, {196, 290}, {240, 297}, {290, 304}, {358, 323}, {377, 362}, {377, 384}, {346.5, 442}, {260, 462}, {172, 439.5}, {137, 369}, {53, 369},
			},
		},
		{
			dParts: []string{
				"M220 50", "q69 0 113 36.5", "t44 78.5", "v94", "q-25 -12 -75.5 -20", "t-87.5 -14", "t-67 -28.5", "t-30 -62.5", "t27 -62", "t76 -22z",
			},
			verts: []vec2{
				{220, 50}, {333, 86.5}, {377, 165}, {377, 259}, {301.5, 239}, {214, 225}, {147, 196.5}, {117, 134}, {144, 72}, {220, 50},
			},
		},
	}
